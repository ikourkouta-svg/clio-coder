...
import { isSessionEntry, type MessageEntry, type SessionEntry } from "../../src/domains/session/entries.js";
...
async function bundle(
	...
	refs?: string[],
	options: { tamper?: boolean; pinnedLeaf?: string; retired?: boolean } = {},
) {
	...
	const result = await buildEvidence({ dataDir: clioDataDir(), stateDir: clioStateDir(), runId: envelope.id });
