#!/usr/bin/env python3
"""
check_physics; scan materials characterization task outputs for physically impossible or
...
Usage:
  python3 assets/scripts/check_physics.py .research/tasks/task-01/*.md
  python3 assets/scripts/check_physics.py --json protocol.md
"""
import argparse
import json
import re
...
def main():
    ap = argparse.ArgumentParser(description="Physical sanity checks for "
                                             "materials characterization task outputs.")
