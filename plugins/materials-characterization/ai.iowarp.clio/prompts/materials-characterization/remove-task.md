...
<objective>
Permanently remove a task from WORKFLOW.md after user confirmation. Use /materials-characterization:archive-task instead if you want to preserve it for reference.
</objective>
...
[ -z "$ARGUMENTS" ] && echo "ERROR: Provide task number. Usage: /materials-characterization:remove-task 3" && exit 1
