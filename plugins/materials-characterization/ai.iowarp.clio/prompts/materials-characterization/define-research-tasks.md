...
@${pluginRoot}/assets/references/traditional-workflows.md
@${pluginRoot}/assets/templates/WORKFLOW.md
</execution_context>
...
**Orchestrator role:** Load research context, present workflow options, gather customizations and scope, run the per-task assumption interview, spawn the materials-characterization-workflow-planner agent to generate WORKFLOW.md, present resource flags and planner defaults for decision, re-dispatch the agent with revisions, create task directories, record.
...
```bash
[ ! -f .research/RESEARCH.md ] && echo "ERROR: No RESEARCH.md. Run /materials-characterization:identify-research first." && exit 1
...
if [ ! -f .research/VIRTUAL-LAB.md ]; then
  echo "NOTE: No VIRTUAL-LAB.md found. Run /materials-characterization:define-virtual-lab to map your resources first."
...
Writing tasks need no interview; they bridge to `/materials-characterization:wtfp`.
...
## 6. Spawn materials-characterization-workflow-planner Agent

```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Materials Characterization ► PLANNING RESEARCH WORKFLOW
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

Use dispatch with `agent: "materials-characterization-workflow-planner"` and a task containing the assignment and full context. The prompt carries:
...
**`needs_input: checkpoint:decision`, `needs_input: checkpoint:human-action`, or `needs_input: checkpoint:human-verify`:** Present the question via ask_user, collect the domain-expert answer, re-dispatch the agent.

## 8. Create Task Directories and State

```bash
python3 "${component:script:research-state}" validate-workflow
...
Optional git record:
```bash
python3 "${component:script:research-state}" record --message "research: workflow defined; [N] tasks, [research type]" --files "${CHANGED_FILES[@]}"
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Materials Characterization ► WORKFLOW DEFINED ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
`/materials-characterization:execute-task 1`
...
- `/materials-characterization:remove-task [N]`; remove a task
- `/materials-characterization:archive-task [N]`; archive without deleting
