...
- options: "Start with current scope" | "I'll add more context" | "Upload papers first; /materials-characterization:upload-data"

## 4. Spawn materials-characterization-literature-reviewer Agent

```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Materials Characterization ► REVIEWING LITERATURE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

Use dispatch with `agent: "materials-characterization-literature-reviewer"` and a task containing the assignment and full context. The prompt carries:
...
- If a suggestion is chosen: update the Selected Prompt and Key Decisions in RESEARCH.md and STATE.md, note the revision reason, then run the keyword gate above. If the change is larger than a rewording, recommend re-running `/materials-characterization:identify-research` with the new framing.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Materials Characterization ► LITERATURE REVIEW COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
`/materials-characterization:define-virtual-lab`
...
**Also available:**
- `/materials-characterization:identify-research`; refine prompt based on gaps found
- `/materials-characterization:upload-data`; add more papers/datasets to review
- `/materials-characterization:define-research-tasks`; skip virtual lab setup and go straight to workflow
