...
```text
/wtfp:new-paper Initialize a wtf-p project from this author-reviewed Materio research handoff.
...
```text
/wtfp:map-project Inventory the Materio research materials for the initialized project at [absolute project root]. Read the existing manifest and state first; do not initialize or replace them.
