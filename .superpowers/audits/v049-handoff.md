...
| S | post-closeout Library ergonomics | Codex tui-library | `src/interactive/overlays/library*.ts` and owned Library tests | honest resource counts, browse/detail flow, Agents/Fleets clarity and safe actions | COMMITTED in this Library slice after S2 PASS; 83 Library and 16 keyboard tests PASS; final CI 663 root pass/1 skip and 24 web pass; live narrow/wide browsing and fleet previews exercised. |
| T | post-closeout workbench ergonomics | Codex tui-workbench | editor, welcome/footer, worker/retry renderers and labels per scratch brief | actionable activity and identity, useful editor affordances, width-safe layout | CLOSURE REVIEW; raw structured identity, pre-abbreviation sanitization and compact honest trust summary returned; 147 focused tests/typecheck PASS; Astra review and final CI running. |

| U | TUI design and guide integration | Codex tui-workbench | CHANGELOG.md, docs/architecture/tui-design.md, docs/guide/commands-and-modes.md | final R/S/T behavior documented without contradictory old contracts | REVIEWING; final R2/S2/T2 documentation integrated; independent Astra documentation review running. |
