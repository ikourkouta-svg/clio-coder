        ...
        if target == "codex":
            ...
            for guide in sorted((output / "assets/actions").glob("*.md")):
                ...
                text = (f"---\ndescription: Materials characterization {guide.stem} workflow.\n---\n\n"
                        ...
                        "materio role agent and include full context; workers return\n"
            ...
            for skill in sorted((output / "skills").glob("*/SKILL.md")):
                role = skill.parent.name.removeprefix("materio-")
            ...
            (output / "GEMINI.md").write_text(
                "# Materials characterization\n\nUse the installed materio skills and their relative action-guide links.\n"
            ...
            directory = output / "commands/materio"
            directory.mkdir(parents=True)
            for guide in sorted((output / "assets/actions").glob("*.md")):
                text = (f"Use the installed materio skills to perform {guide.stem}. "
