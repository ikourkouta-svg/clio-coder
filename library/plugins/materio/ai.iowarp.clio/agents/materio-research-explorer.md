...
skills: [materio-research-explorer]
audience: custom
category: research
...
<clio_skill_binding>
Load the bound skill with context(scope="skills", name="materio-research-explorer"). Read the
